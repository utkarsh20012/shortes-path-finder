...
function recursiveDivision(N,M)
{
    ...
    // for building the walls around the grid.
    for(let i=0; i<M; i++)
    {
    ...
    // wall building around the grid is now done.

    // the divide function is stated below.
    divide(1, N-2, 1, M-2);
    return visitedNodes;
}

// Figure out how the divide function is working.
